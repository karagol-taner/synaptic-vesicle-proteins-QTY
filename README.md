...
- DeepTMHMM output can be visible from DeepTMHMM folder or the outputs are also inmcluded in [Synaptic vesicle proteins.pdf](./Structures/Synaptic vesicle proteins.pdf) file.
