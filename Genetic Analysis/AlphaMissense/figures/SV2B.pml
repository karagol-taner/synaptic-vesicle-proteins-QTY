...
select mutation_PAT,chain A AND 119+239+153+212+218+316+352+269+356+487+497+614+625/c;
show spheres, mutation_PAT;
set sphere_scale, 1, mutation_PAT;
color red,mutation_PAT;
deselect

select mutation_MOD,chain A AND 46+358+350+203+349+581/c;
show spheres, mutation_MOD;
set sphere_scale, 1, mutation_MOD;
color yellow,mutation_MOD;
deselect

select mutation_MILD,chain A AND 498+153+212+218+345+97+323+330+460+643+10+404+515+563+575/c;
